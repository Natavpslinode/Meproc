...
import { getCourseModules, getStudentProgress, supabase } from '@/lib/database';
import type { CourseModule, StudentProgress } from '@/lib/database';
import { BookOpen, Trophy, Clock, CheckCircle, LogOut, Download, GraduationCap, BarChart3 } from 'lucide-react';
...
const StudentDashboard = () => {
  ...
  const canGenerateCertificate = completedModules === modules.length && modules.length === 10;
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-yellow-700">Has completado todos los módulos. Puedes generar tu certificado.</p>
                </div>
              </div>
