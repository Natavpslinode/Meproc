...
import { getCourseModules, getStudentProgress, updateModuleProgress, supabase } from '@/lib/database';
import type { CourseModule, StudentProgress, CourseMaterial } from '@/lib/database';
import { ArrowLeft, CheckCircle, Clock, Play, Image, FileText, Download } from 'lucide-react';
